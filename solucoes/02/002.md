...
public class Squad : IUnit
{
    ...
    // Propriedade pública read-only que permite a código externo aceder à
    // informação de untCol do Squad, mas não alterá-la
    public ICollection<IUnit> UntCol
    {
        get => untCol;
    }
    ...
    {
        get => $"Group of {untCol.Count} units";
    }
    ...
    {
        untCol = new List<IUnit>();
        foreach (IUnit u in units) untCol.Add(u);
    }
...
class Program
{
    static void Main(string[] args)
    {
        // Criar variável do tipo ICollection<IUnit> e testar guardar uma
        // lista na mesma
        ICollection<IUnit> unitBundle1 = new List<IUnit>()
        {
        ...
        // Criar variável do tipo ICollection<IUnit> e testar guardar um
        // hashset na mesma
        ICollection<IUnit> unitBundle2 = new HashSet<IUnit>()
        {
