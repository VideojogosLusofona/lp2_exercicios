...
namespace Ex_11
{
    public abstract class TileDecorator : Tile
    {
        ...
        public override int DefensePoints => _baseTile.DefensePoints;
        public override int EssentialPoints => _baseTile.EssentialPoints;
        public override int LuxuryPoints => _baseTile.LuxuryPoints;

        public TileDecorator(Tile tileBase) : 
            base(tileBase.DefensePoints, tileBase.EssentialPoints, tileBase.LuxuryPoints)
        {
            _baseTile = tileBase;
        }
    }
