...
namespace Ex_11
{
    public abstract class Tile
    {
        ...
        public abstract int EssentialPoints { get; }
        public abstract int LuxuryPoints { get; }
    }
}
```
...
namespace Ex_11
{
    public abstract class TileDecorator : Tile
    {
        ...
        public override int DefensePoints { get; }
        public override int EssentialPoints { get; }
        public override int LuxuryPoints { get; }

        public TileDecorator(Tile tileBase)
        {
            _baseTile = tileBase;
            DefensePoints = _baseTile.DefensePoints;
            EssentialPoints = _baseTile.EssentialPoints;
            LuxuryPoints = _baseTile.LuxuryPoints;
        }
    }
}
```
