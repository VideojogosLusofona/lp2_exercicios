...
<<<<<<< HEAD
1 - Escreve um programa que aceite dois ou mais n�meros inteiros como
par�metros na linha de comandos, coloque esses n�meros num _array_ de `ints` e
apresente ao utilizador um menu com as seguintes op��es:

1. Obter m�dia dos valores no _array_
2. Obter mediana dos valores no _array_
3. Obter moda dos valores no _array_
4. Obter m�ximo dos valores no _array_
5. Obter m�nimo dos valores _no_array_
6. Sair

O programa deve funcionar em ciclo, realizando os pedidos efetuados, terminando
apenas quando o utilizador selecionar a op��o 6.
=======
1 - Escreve um programa que aceite dois ou mais nÃºmeros inteiros como
parÃ¢metros na linha de comandos, coloque esses nÃºmeros num _array_ de `ints` e
apresente ao utilizador um menu com as seguintes opÃ§Ãµes:

1. Obter mÃ©dia dos valores no _array_
2. Obter mediana dos valores no _array_
3. Obter moda dos valores no _array_
4. Obter mÃ¡ximo dos valores no _array_
5. Obter mÃ­nimo dos valores _no_array_
6. Sair

O programa deve funcionar em ciclo, realizando os pedidos efetuados, terminando
apenas quando o utilizador selecionar a opÃ§Ã£o 6.
>>>>>>> Correção no Ex1
...
*Por [Jo�o Rebelo](https://github.com/JBernardoRebelo)*
...
<<<<<<< HEAD
        static void Main(string[] args)
        {
            ...
            // Criar uma nova instancia de Calculo j� com o array de ints
...
=======
        // Criar uma nova instancia de Calculo
        Calculo calculo;
...
<<<<<<< HEAD
            // Calculamos a mediana dependendo se o tamanho do array � par ou impar
=======
            // Calculamos a mediana dependendo se o tamanho do array é par ou impar
>>>>>>> Correção no Ex1
            retVal = (ordIntigers.Length % 2 != 0) ?
