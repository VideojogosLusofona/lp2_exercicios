...
namespace exercicio1
{
    class Program
    {
        ...
        private static int avgresult;
        private static int medianresult;
        private static int moderesult;
        ...
        private static void Main(string[] args) {
            ...
            for(int i = 0; i < arraynumbers.Length; i++) {
                arraynumbers[count] = Int32.Parse(args[count]);
                count++;
            }
            //
        ...
        private static void Median() {
            ...
            if (arraynumbers.Length % 2 == 0) { // Verificar se é par
                ...
                int midhigh = arraynumbers[arraynumbers.Length / 2];
                int midlow = arraynumbers[arraynumbers.Length / 2] - 1;
                //
        ...
        private static void Result() {
            Console.WriteLine($"O resultado é: {showresult}");
        }
    }
}
