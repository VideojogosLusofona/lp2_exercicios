...
os objetos reutilizáveis são todos criados à partida. Se caso forem pedidos
mais objetos do que aqueles inicialmente disponíveis, deve ser lançada uma
`InvalidOperationException`.

> [Soluções](../solucoes/02/072.md)

---

73 - Relativamente ao _Object Pool design pattern_, descreve por palavras tuas:

1. As circunstâncias em que é apropriado usar o _pattern_.
...
- Quando um novo monstro é criado, tem os mesmos `Power`s do monstro original;
  no entanto, a lista de poderes de cada monstro pode variar ao longo do tempo
  para cada monstro individual, sem afetar a lista de poderes dos restantes.
...
- O dicionário de _kills_ por nome do inimigo é específico a cada monstro.
